...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    h5.blue_icon.my-3(data-aos="fade-left") Clasificación según la presión ejercida
    .row.justify-content-center.my-3
      .col-lg-10                        
        .row.mt-3.mb-3.align-items-center(data-aos="fade-left")
          .col-auto
            img(src='@/assets/curso/temas/tema1/img2.svg', alt='Imagen decorativa')
          .col.px-0
            h3.mb-0 Aplicación de técnicas con el uso de presión de agua
    ...
    .row.justify-content-center.my-3
      .col-lg-10                        
        ...
        ul.mt-0
          li 
            span <b>Tercera capa:</b> tela de lana seca.
    ...
    h5.blue_icon.my-3(data-aos="fade-left") Técnicas asociadas a la hidroterapia
        ...
        .row.justify-content-center
          .col-lg-9.align-content-center
            .row
              ...
              .col-lg-9
                p.my-1 Estados febriles inespecíficos.
            .row
              .col-lg-3
                p.my-1 <b>Contraindicaciones 2</b>
              .col-lg-9
                p.my-1 Alteraciones de la función termorreguladora de la piel.
            .row
              .col-lg-3
